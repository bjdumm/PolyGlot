...
class langPanel(wx.Panel):
    ...
    def __init__(self, parent):
        super(langPanel,self).__init__(parent,pos=wx.Point(1000,0), size=wx.Size(1000,500))
        self.enterLang = wx.TextCtrl(self, -1, "Enter new language", wx.Point(175,15))
...
class TreePanel(wx.Panel):
    def __init__(self, parent, size, pos):
        ...
        tree = wx.TreeCtrl(self,size=wx.Size(250,3000))
...
class TestFrame(wx.Frame):
    def __init__(self):
        ...
        gridPanel = GridPanel(self, size=wx.Size(715,1000), pos=wx.Point(250,0))
        treePanel = TreePanel(self, size=wx.Size(250,1800), pos= wx.Point(0,0))
        langPan = langPanel(self)        
